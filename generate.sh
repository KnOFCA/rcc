...
java -cp $CLASSPATH org.antlr.v4.Tool -Dlanguage=Cpp -listener -visitor -o generated/ -package antlrcpptest ANTLR/TLexer.g4 
java -cp $CLASSPATH org.antlr.v4.Tool -Dlanguage=Cpp -listener -visitor -o generated/ -lib generated/ANTLR -package antlrcpptest ANTLR/TParser.g4
